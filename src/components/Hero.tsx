        ...
        <div className="grid md:grid-cols-2 items-center gap-y-10 sm:gap-y-12 md:gap-y-0">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div
              ...
              style={{ ["--accent" as any]: ACCENT }} // provide --accent for children
            >
          ...
          <div className="mt-8 sm:mt-10 md:mt-0">
            ...
            <p className="mt-8 max-w-xl text-neutral-300">
              I turn fuzzy ideas into shipped products—web apps, data pipelines, and cybersecurity tooling. I care about
              clean systems, clear UX, and measurable impact.
            </p>
            <p className="mt-8 max-w-xl text-neutral-300">
